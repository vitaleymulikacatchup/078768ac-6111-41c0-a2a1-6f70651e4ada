...
export const metadata: Metadata = {
  title: "Aroma Café - Premium Coffee & Warm Community",
  description: "Experience exceptional coffee crafted with passion at Aroma Café. Premium beans, expert roasting, and a welcoming atmosphere where every cup tells a story.",
  keywords: ["coffee shop", "premium coffee", "artisan roasted", "espresso", "cappuccino", "local café", "coffee beans", "barista"],
  metadataBase: new URL("https://aromacafe.com"),
  alternates: {
    canonical: "https://aromacafe.com"
  },
  openGraph: {
    title: "Aroma Café - Premium Coffee & Warm Community",
    description: "Experience exceptional coffee crafted with passion at Aroma Café. Premium beans, expert roasting, and a welcoming atmosphere.",
    url: "https://aromacafe.com",
    siteName: "Aroma Café",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763483586391-5gq8k2cm.jpg",
  ...
  twitter: {
    ...
    title: "Aroma Café - Premium Coffee & Warm Community",
    description: "Experience exceptional coffee crafted with passion at Aroma Café.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763483586391-5gq8k2cm.jpg"]
  },
  robots: {
    index: true,
    follow: true
